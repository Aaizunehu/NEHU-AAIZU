...
module.exports.run = async function ({ api, event, args }) {
    ...
    if (userMessage.toLowerCase() === "on") {
        ...
        return api.sendMessage("Hyee baby! 😘 Botni auto-reply mode **ON** ho gaya... Ab sirf tumhare liye romantic ban gayi hu ❤️", threadID, messageID);
    }
    ...
    if (userMessage.toLowerCase() === "off") {
        ...
        return api.sendMessage("Hmm! 😒 Botni auto-reply mode **OFF** ho gaya... Tumne ignore kar diya na baby? 🥺", threadID, messageID);
    }
